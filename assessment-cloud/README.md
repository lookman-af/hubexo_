...
| 3. Infrastructure as Code | [Terraform and HashiCorp Vault](aws-terraform-vault/README.md) | [ZIP](aws-terraform-vault/aws-eks-vault-terraform.zip) |
| 4. Deployment Pipeline | [Draft status](deployment-pipeline/README.md) | [Pipeline draft](deployment-pipeline/pipeline.md) |

PDFs and downloadable packages live alongside their source files. Start with the
