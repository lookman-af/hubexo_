# AWS EKS Platform - Design Document
...
A governed AWS landing zone with isolated environments and a repeatable Amazon EKS platform.
...
Acceptance: account vending and repeatable rebuild succeed; AZ-loss, backup restore, and regional recovery exercises meet the agreed service-tier targets.
...
[2] [AFT scope](https://docs.aws.amazon.com/controltower/latest/userguide/aft-overview.html)
[3] [EKS reliability](https://docs.aws.amazon.com/eks/latest/best-practices/application.html)
[4] [Aurora Global Database](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database.html)

## 02  Security controls

Layer organization guardrails, workload identity, Kubernetes policy, and independent security monitoring.
...
Acceptance: unauthorized role escalation, cross-environment secret access, privileged pods, unsigned images, and expired production elevation are rejected and auditable.

[5] [EKS identity and access](https://docs.aws.amazon.com/eks/latest/best-practices/identity-and-access-management.html)
[6] [EKS Pod Identity](https://docs.aws.amazon.com/eks/latest/userguide/pod-identities.html)
[7] [Control behavior](https://docs.aws.amazon.com/controltower/latest/controlreference/control-behavior.html)
[8] [EKS security](https://docs.aws.amazon.com/eks/latest/best-practices/security.html)

## 03  Networking approach

Private application tiers, controlled cross-account connectivity, and explicit traffic paths.
...
Acceptance: no direct public path to workers or databases; approved ingress/API paths work; nonproduction-to-production traffic and unapproved egress are blocked.

[9] [CloudFront VPC origins](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-vpc-origins.html)
[10] [EKS load balancing](https://docs.aws.amazon.com/eks/latest/best-practices/load-balancing.html)
[11] [EKS network security](https://docs.aws.amazon.com/eks/latest/best-practices/network-security.html)

## 04  Observability strategy

Correlate customer outcomes, Kubernetes health, cloud changes, and AI activity without collecting unlimited data.
...
Acceptance: a synthetic failed transaction and a denied AI operation can be traced end to end; alerts reach the correct owner; telemetry loss is detected.

[12] [EKS monitoring and logs](https://docs.aws.amazon.com/eks/latest/userguide/eks-observe.html)
[13] [Observability cost controls](https://docs.aws.amazon.com/eks/latest/best-practices/cost-opt-observability.html)

## 05-06  Developer experience and cost management

Make the approved path easy to use and give each team ownership of measurable unit costs.
...
Acceptance: a team can onboard and deploy through the portal; every service has an owner/cost allocation; optimization savings are verified against SLOs.

[14] [EKS split cost allocation](https://docs.aws.amazon.com/cur/latest/userguide/split-cost-allocation-data.html)
[15] [AWS Cost Anomaly Detection](https://docs.aws.amazon.com/cost-management/latest/userguide/getting-started-ad.html)

## 07  AI governance controls

Agents propose and execute bounded tasks; identity, approval, and enforcement remain outside the model.
...
Acceptance: injected instructions cannot bypass policy; changed targets invalidate approval; a suspension drill stops tool execution and leaves a complete audit trail.

[16] [Bedrock prompt-attack detection](https://docs.aws.amazon.com/bedrock/latest/userguide/guardrails-prompt-attack.html)
[17] [Revoke IAM role sessions](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_revoke-sessions.html)
